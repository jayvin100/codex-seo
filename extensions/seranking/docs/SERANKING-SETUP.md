...
`SKILL.md` into `~/.codex/skills/seo-seranking/`, and writes
`env.SERANKING_API_KEY` into `~/.codex/settings.json` with mode 0o600.
...
```
/seo seranking ai-visibility "Codex SEO"
```
